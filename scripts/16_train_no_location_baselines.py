...
SPLIT_DIR = Path("data/processed/ml_ready_no_location/splits")

OUTPUT_DIR = Path("models/no_location_baselines")
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

REPORT_DIR = Path("reports/ml_no_location")
REPORT_DIR.mkdir(parents=True, exist_ok=True)

SUMMARY_CSV_PATH = REPORT_DIR / "baseline_model_summary.csv"
SUMMARY_MD_PATH = REPORT_DIR / "baseline_model_report.md"
BEST_MODEL_PATH = OUTPUT_DIR / "best_no_location_baseline_model.joblib"
